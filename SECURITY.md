...
Report via **[GitHub Security Advisories](https://github.com/bold-minds/list/security/advisories/new)**. This creates a confidential channel between you and the maintainers.
